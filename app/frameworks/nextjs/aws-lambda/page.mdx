...
<Cards>
  <Cards.Card title="GitHub Actions" href="/frameworks/nextjs/aws-lambda/github" />
  <Cards.Card title="GitLab CI" href="/frameworks/nextjs/aws-lambda/gitlab" />
</Cards>
...
|--------------|--------|----------------|
| Memory allocation | 🟢 High | Adjust based on profiling |
| Cold start reduction | 🟡 Medium | Use provisioned concurrency |
| Asset optimization | 🟢 High | Enable image optimization |
...
<Cards>
  <Cards.Card title="Set up GitHub Actions" href="/frameworks/nextjs/aws-lambda/github" />
  <Cards.Card title="Set up GitLab CI" href="/frameworks/nextjs/aws-lambda/gitlab" />
